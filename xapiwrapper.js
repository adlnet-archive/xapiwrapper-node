...
function CreateWrapper(ADL1,base1,location1){
...
return (function(){  
     ...
     *                     wrapper
     */
    XAPIWrapper = function(config, verifyxapiversion,base,location)
    {
    ...
    function delay() 
    {
        ...
        var url = location.toString() + '?forcenocache='+ADL.ruuid();
    ...
    */
    ...
    ADL.XAPIWrapper = new XAPIWrapper(Config, false, base, location);
    })();
};


exports.configure = function(base,href,protocol,port,hostname)
{

   //global var which will be exported
  var XAPI = {};
  var base = base;
  var location = {
    href:href,
  ...
  CreateWrapper(XAPI,base,location);
  return XAPI;
} 
